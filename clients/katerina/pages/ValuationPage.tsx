        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            >
              ...
              <p className="text-[#3D3D3D] text-sm">
                {t('In-depth knowledge of the South Florida market', 'Conocimiento profundo del mercado del Sur de Florida')}
              </p>
            </motion.div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      required
                      placeholder={t('123 Lake Ave, Lake Worth, FL', '123 Lake Ave, Lake Worth, FL')}
                      className="w-full px-4 py-3 border border-[#D6BFAE] focus:outline-none focus:ring-2 focus:ring-[#C4A25A]"
                    />
                  </div>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-[#3D3D3D] text-lg mb-8 max-w-2xl mx-auto">
              {t(
                'As a dedicated realtor serving the Lake Worth and South Florida community, I provide personalized service and expert guidance throughout your home selling journey. From accurate pricing to strategic marketing, I\'m committed to getting you the best results.',
                'Como agente inmobiliaria dedicada sirviendo a la comunidad de Lake Worth y el Sur de Florida, proporciono servicio personalizado y orientación experta durante todo tu proceso de venta. Desde precios precisos hasta marketing estratégico, estoy comprometida a obtener los mejores resultados para ti.'
              )}
            </p>
            <Link
              href="/about"
