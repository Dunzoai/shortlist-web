...
export function ListingDetailPage() {
  ...
  const getShareUrl = () => {
    ...
    return `https://katerina-demo.shortlistpass.com/listings/${params.id}`;
  };
            ...
            <div className="lg:col-span-1">
              ...
              >
                <div className="text-center mb-6">
                  <div className="rounded-full mx-auto mb-4 w-[100px] h-[100px] bg-[#1B365D] flex items-center justify-center">
