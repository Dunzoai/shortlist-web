...
const placeholderPosts: BlogPost[] = [
  ...
  {
    id: '6',
    title: 'The South Florida Real Estate Market in 2024',
    slug: 'south-florida-market-2024',
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-[#D6BFAE] text-xl max-w-2xl mx-auto">
              {t(
                'Insights, tips, and guides for buying and selling homes in South Florida',
                'Consejos y guías para comprar y vender casas en el Sur de Florida'
              )}
            </p>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="text-center md:text-right">
              <p className="text-white/60 text-sm">
                © {new Date().getFullYear()} Katerina Sells Florida. {t('All rights reserved.', 'Todos los derechos reservados.')}
              </p>
            </div>
          </div>
        </div>
