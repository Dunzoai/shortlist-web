          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
              ...
              <p className="text-[#3D3D3D] text-lg leading-relaxed mb-8">
                {t(
                  "Whether you're ready to buy, sell, or just have questions about the South Florida real estate market, I'm here to help. Reach out in whichever way is most convenient for you.",
                  "Ya sea que estés listo para comprar, vender, o simplemente tengas preguntas sobre el mercado inmobiliario del Sur de Florida, estoy aquí para ayudar. Contáctame de la manera que te sea más conveniente."
                )}
              </p>
              ...
              <div className="space-y-6 mb-12">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+15551234567" className="text-[#3D3D3D] hover:text-[#C4A25A] transition-colors">
                      (555) 123-4567
                    </a>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:katerina@example.com" className="text-[#3D3D3D] hover:text-[#C4A25A] transition-colors">
