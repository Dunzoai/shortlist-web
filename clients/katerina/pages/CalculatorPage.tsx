...
import MortgageCalculator from '@/clients/katerina/components/MortgageCalculator';
              ...
              <div>
                ...
                <ul className="space-y-2 text-[#3D3D3D]">
                  ...
                  <li className="flex items-start">
                    ...
                    <span>
                      {t(
                        'Work with Katerina to find your dream home',
                        'Trabaja con Katerina para encontrar tu casa soñada'
                      )}
                    </span>
                  </li>
                </ul>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                {t('Contact Katerina', 'Contacta a Katerina')}
              </Link>
              <Link
                href="/buyers"
