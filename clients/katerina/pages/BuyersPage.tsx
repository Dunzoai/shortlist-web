...
const placeholderPosts: BlogPost[] = [
  {
    ...
    excerpt: 'Everything you need to know about buying your first home in the South Florida area. From pre-approval to closing day.',
  ...
  {
    id: '2',
    title: 'Understanding Mortgage Options in Florida',
    slug: 'mortgage-options-florida',
    excerpt: 'Compare different mortgage types available to buyers in FL, including FHA, VA, and conventional loans.',
...
const buyerResources = [
  ...
  },
  {
    ...
    icon: GraduationCap,
    link: 'https://www.greatschools.org/florida/lake-worth/',
    external: true
  },
  {
    titleEn: 'Area Guide',
    titleEs: 'Guía del Área',
    descEn: 'Explore Lake Worth neighborhoods',
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-[#D6BFAE] text-xl max-w-2xl mx-auto">
              {t(
                'Your guide to finding the perfect home in Lake Worth',
                'Tu guía para encontrar el hogar perfecto en Lake Worth'
              )}
            </p>
          </motion.div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-[#D6BFAE] text-lg mb-8">
              {t(
                "Let me help you navigate the South Florida real estate market. I'll be with you every step of the way.",
                "Déjame ayudarte a navegar el mercado inmobiliario del Sur de Florida. Estaré contigo en cada paso del camino."
              )}
            </p>
