      ...
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          <p className="text-white/80 text-lg md:text-xl max-w-2xl mx-auto mb-10">
            {t(
              "From South Florida to the world's most sought-after destinations",
              'Desde el Sur de Florida hasta los destinos más codiciados del mundo'
            )}
          </p>
      ...
      >
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            >
              {t(
                "As your trusted real estate advisor, my network extends beyond South Florida. Whether you're dreaming of a beachfront villa in Cancun or an investment property in Dubai, I connect you with vetted international partners to make your global real estate dreams a reality.",
                'Como tu asesora inmobiliaria de confianza, mi red se extiende más allá del Sur de Florida. Ya sea que sueñes con una villa frente al mar en Cancún o una propiedad de inversión en Dubai, te conecto con socios internacionales verificados para hacer realidad tus sueños inmobiliarios globales.'
              )}
            </motion.p>
