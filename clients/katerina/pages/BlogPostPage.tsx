...
const placeholderPost: BlogPost = {
  id: '1',
  title: 'First-Time Homebuyer Guide for South Florida',
  slug: 'first-time-homebuyer-guide',
  content: `
    <p>Buying your first home is an exciting milestone, and South Florida offers incredible opportunities for first-time buyers. This comprehensive guide will walk you through everything you need to know.</p>
    ...
    <p>Your budget should account for more than just the purchase price. Consider closing costs, property taxes, homeowners insurance, and potential HOA fees. In South Florida, property taxes are relatively low compared to other coastal areas.</p>

    <h2>Choosing the Right Neighborhood</h2>
    <p>South Florida offers diverse neighborhoods to suit different lifestyles. Whether you prefer beachfront living, golf course communities, or quiet suburban streets, there's something for everyone.</p>
  ...
  `,
  excerpt: 'Everything you need to know about buying your first home in the South Florida area.',
...
const relatedPosts = [
  ...
  {
    id: '3',
    title: 'Best Neighborhoods in South Florida for Families',
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            ...
            <div className="flex items-center gap-4 text-white/70 text-lg">
              <span>{post.author || 'Katerina'}</span>
              <span>•</span>
              <span>
        ...
        <div className="max-w-2xl mx-auto px-6">
          ...
          <div className="mt-16 p-8 bg-[#F7F7F7] rounded-lg">
            <div className="flex items-center gap-6">
              <div className="rounded-full overflow-hidden w-20 h-20 flex-shrink-0 bg-[#1B365D] flex items-center justify-center">
