    ...
    <div className="bg-white rounded-lg shadow-xl p-8 max-w-4xl mx-auto">
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col justify-between">
          ...
          <div className="mt-8">
            ...
            >
              {t('Get Pre-Approved - Talk to Katerina', 'Obtén Pre-Aprobación - Habla con Katerina')}
            </Link>
          </div>
        </div>
      </div>
      ...
      <div className="mt-8 pt-6 border-t border-[#D6BFAE]">
        <p className="text-xs text-[#3D3D3D] text-center">
          {t(
            'This calculator provides an estimate only. Actual monthly payment may vary based on property taxes, insurance, HOA fees, and other factors. Contact Katerina for a detailed breakdown.',
            'Esta calculadora proporciona solo una estimación. El pago mensual real puede variar según los impuestos a la propiedad, seguros, tarifas de HOA y otros factores. Contacta a Katerina para un desglose detallado.'
          )}
        </p>
      </div>
    </div>
