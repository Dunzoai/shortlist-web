...
export default function ChatLanguageControls() {
  ...
  return (
    <button
      ...
      className={`fixed bottom-6 left-6 z-[9999] flex items-center gap-2 bg-white text-[#1B365D] text-sm border border-[#1B365D]/30 rounded-full px-4 py-2 hover:bg-[#F7F7F7] shadow-lg cursor-pointer transition-all duration-300 ${
