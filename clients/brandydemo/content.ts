...
const content = {
  ...
  admin: {
    ...
    orders: {
      ...
      empty: 'No orders yet.',
      noneInView: 'No orders in this view.',
    ...
    settings: {
      ...
      subtitle: 'Set the tax and shipping added to every order at checkout. Shoppers see these in their cart and on the Square checkout page.',
      taxLabel: 'Sales tax rate (%)',
      taxHint: 'e.g. 6 for 6% — applied to the product subtotal. Leave 0 for no tax.',
      taxPlaceholder: '0',
      shippingLabel: 'Flat shipping ($)',
      shippingHint: 'e.g. 5.00 — a flat rate added to every order.',
      shippingPlaceholder: '0.00',
      carrierLabel: 'Shipping method / carrier',
      carrierHint: 'e.g. USPS First-Class — shown to the shopper.',
      carrierPlaceholder: 'USPS First-Class',
      freeLabel: 'Free shipping over ($)',
      freeHint: 'e.g. 50 — orders at or above this ship free. Leave blank for none.',
      freePlaceholder: 'Optional',
      save: 'Save settings',
      saving: 'Saving…',
      saved: 'Saved',
      loading: 'Loading…',
